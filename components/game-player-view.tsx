...
export function GamePlayerView({ game }: { game: Game }) {
          ...
          <div className="modal">
            ...
            {!saved ? (
              <div className="input-row">
                <input value={name} onChange={(e) => setNameOverride(e.target.value.toUpperCase().slice(0, 10))} placeholder="TUS INICIALES" />
                <button
